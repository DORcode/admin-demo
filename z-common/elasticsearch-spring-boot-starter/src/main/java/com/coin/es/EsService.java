...
import com.coin.es.config.RestClientCallback;
...
public class EsService {
    ...
    public void bulkDeleteDoc(String index, List<Map<String, Object>> sources) {
        BulkRequest bulkRequest = new BulkRequest();
        for(Map<String, ?> source : sources) {
            if(!Objects.isNull(source.get("id"))) {
                DeleteRequest deleteRequest = new DeleteRequest(index, (String) source.get("id"));
...
//                "}");
     ...
     */
    public void bulkInsert(String index, List<Map<String, Object>> sources) {
        BulkRequest bulkRequest = new BulkRequest();
        for(Map map : sources) {
            IndexRequest indexRequest = new IndexRequest(index);
     ...
     */
    public void bulkInsert(String index, String pipeline, List<Map<String, Object>> sources) {
        BulkRequest bulkRequest = new BulkRequest();
        for(Map<String, ?> source : sources) {
            IndexRequest indexRequest = new IndexRequest(index);
            indexRequest.source(source);
